class StoreFlavorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @store_flavor.save
        ...
        format.js             
        format.html { redirect_to @store, notice: 'Store flavor was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @store_flavor.update(store_flavor_params)
        format.html { redirect_to @store, notice: 'Store flavor was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|    
      @flavors = @store.store_flavors.to_a.paginate(:page => params[:flavors_page], :per_page => 5)  
      format.js      
      format.html { redirect_to @store, notice: 'Store flavor was successfully destroyed.' }
