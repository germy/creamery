class FlavorsController < ApplicationController
  ...
  # GET /flavors.json
  def index
    @flavors = Flavor.all.to_a.paginate(:page => params[:flavors_page], :per_page => 10)
  end

  # GET /flavors/1
  # GET /flavors/1.json
  def show
    @stores = StoreFlavor.for_store(@flavor).to_a.paginate(:page => params[:stores_page], :per_page => 10)
  end
