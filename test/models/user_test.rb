...
class UserTest < ActiveSupport::TestCase
  ...
  context "Creating a context for users" do
    ...
    should "require unique email types" do
      @kathryn = FactoryGirl.create(:employee, first_name: "Kathryn", last_name: "Janeway", role: "manager", date_of_birth: 30.years.ago.to_date)
      @ed_user = FactoryGirl.build(:user, employee: @kathryn, email: "ED@example.com", password: "bob", password_confirmation: "bob")
      deny @ed_user.valid?
    end
    ...
    should "destroy user if employee destroyed" do
      ...
      freeman_user = FactoryGirl.create(:user, employee: freeman, email: "mdf@example.com", password: "bob", password_confirmation: "bob")
      freeman_user.reload
